<template>
  <div :class="commentsClass">
    <img src="../assets/logo/close.png" alt="close logo" class="top-left" @click="changeState">

    <get-comment :caption="caption" @state="changeState" :send="send"/>
...
export default {
  ...
  computed: {
    commentsClass() {
      return this.mode === 'inline' ? 'commentsInline' : 'commentsFullscreen'
    },
  },
